    ...
    <body>
        <div class="container">
            ...
            <div class="upload-section fade-in" style="margin-top: 40px;">
                <h2 class="card-title">📋 Budget Templates</h2>
                <p style="color: #7f8c8d; margin-bottom: 20px;">
                ...
                <a href="/templates" class="btn btn-primary" style="font-size: 1.1rem; padding: 12px 32px;">
...
def upload_file():
    ...
    try:
        ...
        analysis_cache[file_id] = {
            ...
            'risk_level': risk_analysis.get('summary', {}).get('risk_level', 'MODERATE'),
            'risk_score': risk_analysis.get('summary', {}).get('overall_risk_score', 0),
        ...
        <body>
            <div class="container">
                ...
                <div class="stats-grid fade-in">
                    ...
                    <div class="stat-card">
                        <div class="stat-icon">⚠️</div>
                        <div class="stat-value">{data.get('risk_level', 'MODERATE').upper()}</div>
...
def generate_pdf_report(file_id):
    ...
    try:
        ...
        risk_data = {
            'risk_level': data.get('risk_level', 'MODERATE'),
            'overall_risk_score': data.get('risk_score', 0),
            'risk_categories': data.get('risk_analysis', {}).get('items_by_category', {})
        }
...
def budget_history_page():
    ...
    <body>
        ...
        # Add this to existing button groups in analysis pages
"""
<div class="btn-group fade-in">
    <a href="/" class="btn btn-primary">🏠 Dashboard</a>
    <a href="/templates" class="btn btn-secondary">📋 Templates</a>
    <a href="/budget-history" class="btn btn-secondary">🔄 Compare</a>
</div>
"""
    </body>
    </html>
